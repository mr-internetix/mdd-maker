...
class DDF:
    ...
    def __init__(self, path_to_mdd, path_to_ddf, verbose=False):
        self.ddf = path_to_ddf
    ...
    def _get_value_part_dict(self, variable_fullname):
        ...
        for _, c in v.Categories.items():
            d[c.Value] = c.Name + "__" + slugify(c.Label)
    ...
    def split(self, n, output_dir, split_into_folders=True):
        ...
        for i in range(1, n + 1):
            ...
            split_filename = os.path.normpath(os.path.join(split_folder, original_filename_without_extension + ".part-" + str(i) + ".ddf"))
    ...
    def split_on_variable(self, variable_fullname, output_folder=".\\"):
        ...
        for value, ids in split_ids.items():
            ...
            try:
                newddf = os.path.join(output_folder, original_ddf_without_extension + "." + part + ".ddf")
                newmdd = os.path.join(output_folder, original_mdd_without_extension + "." + part + ".mdd")
    ...
    def _list_of_all_var_names(self):
        ...
        """
        var_lst = [ var.FullName.lower() for var in self.mdm.VariableInstances ]
